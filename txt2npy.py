...
'''
*** BORROWED CODE ***
Original work by: Amir Shahroudy 
...
user_name = 'user'
save_npy_path = 'D:/Vivi/Documents/NTU/Skeleton/all_npy/'
load_txt_path = 'D:/Vivi/Documents/NTU/Skeleton/all/'
missing_file_path = 'D:/Vivi/Documents/NTU/Skeleton/missing_txt.txt'
...
if __name__ == '__main__':
    ...
    for ind, each in enumerate(datalist):
        ...
        if S not in step_ranges:
            continue 
        if each+'_rgb.npy' in alread_exist_dict:
        ...
        mat = np.array(mat)
        save_path = save_npy_path+'{}_rgb.npy'.format(each[:-9])
